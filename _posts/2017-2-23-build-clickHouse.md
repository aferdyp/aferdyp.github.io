Here are some instructions to build ClickHouse on Centos 7
...
This note is meant for those who simply need to get ClickHouse running on Centos 7 without the explicit need to get rpms in place. 
